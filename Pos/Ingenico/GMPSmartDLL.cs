...
namespace Pos.Ingenico
{
    ...
    public class GMPSmartDLL
    {
        ...
        internal static uint FP3_Start(uint currentInterface, ref ulong tranHandle, byte isBackground, byte[] v1, int v2, object tsmSign, object p1, object p2, int v3, int v4)
        {
