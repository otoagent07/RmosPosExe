...
namespace Pos
{
    public class ParserClass
    {
        ...
        static public IngenicoConn MainControls;
        ...
        public static void DisplayEcrStatus(ST_GMP_PAIR_RESP stPairResp, ST_ECHO echoStr)
        {
            ...
            IngenicoConn.m_tvEcho.Nodes.Clear();

            DisplayStructInTree("dll Version", GMP_Tools.SetEncoding(IngenicoConn.m_dllVersion));
        ...
        {
            IngenicoConn.m_tvEcho.Nodes.Add(memberName.PadRight(20, ' ') + " " + value.PadRight(10, ' '));
        }
    }
}
