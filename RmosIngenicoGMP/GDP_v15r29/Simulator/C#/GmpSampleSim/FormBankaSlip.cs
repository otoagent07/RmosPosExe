...
{
    public partial class SlipForm : XtraForm
    {
        Main parent;
        uint Retcode = 0;
        int slipLen = 0;

        public SlipForm(Main parent)
        {
            this.parent = parent;
            InitializeComponent();
            ...
            Retcode = Json_GMPSmartDLL.FP3_GetTicket(Main.CurrentInterface, 
        ...
        private IList<SlipLine> GetSlipLines()
        {
            ...
            try
                ...
                Retcode = GMPSmartDLL.FP3_GetMerchantSlip(Main.CurrentInterface,
