    ...
    public partial class Test : XtraForm
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < echoCount; i++)
            {
                ...
                Json_GMPSmartDLL.FP3_Echo(Main.CurrentInterface, ref stEcho, Defines.TIMEOUT_ECHO);
                duration1 = DateTime.Now - start1;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Convert.ToInt32(textBox5.Text) - 1; i++)
            {
                ...
                resp = Json_GMPSmartDLL.FP3_StartPairingInit(Main.CurrentInterface, ref pairing, ref pairingResp);
        ...
        private void m_btnCreateInterface_Click(object sender, EventArgs e)
        {
            ...
            UInt32 Retcode = Json_GMPSmartDLL.FP3_CreateInterface(ref Main.CurrentInterface, "COM5", 0, stXmlInterfaceData);
        ...
        private void m_btnGetTlvData_Click(object sender, EventArgs e)
        {
            ...
            UInt32 Retcode = GMPSmartDLL.FP3_GetTlvData(Main.CurrentInterface, Defines.GMP_EXT_DEVICE_TAG_Z_NO, arr, (short)arr.Length, ref len);

            if (len != 0)
            {
                MessageBox.Show("Z No : " + Main.ConvertByteArrayToString(arr, len));
            }
        ...
        private void m_btnSetTlvData_Click(object sender, EventArgs e)
        {
            ...
            Main.ConvertStringToHexArray("000010001000", ref arr2, len2);

            UInt32 Retcode = GMPSmartDLL.FP3_SetTlvData(Main.CurrentInterface, Defines.GMP_EXT_DEVICE_FIS_LIMIT, arr2, (UInt16)len2);
        ...
        private void m_btnGetTaxRates_Click(object sender, EventArgs e)
        {
            ...
            Retcode = Json_GMPSmartDLL.FP3_GetTaxRates(Main.CurrentInterface, ref numberOfTotalTaxRates, ref numberOfTotalRecordsReceived, ref stTaxRates, 8);
        ...
        private void m_btnTestUserMessage_Click(object sender, EventArgs e)
        {
            ...
            Retcode = Json_GMPSmartDLL.FP3_PrintUserMessage_Ex(Main.CurrentInterface, Main.ActiveTransactionHandle, ref stUserMessage, 1, ref m_stTicket, Defines.TIMEOUT_DEFAULT);
            ...
            Retcode = Json_GMPSmartDLL.FP3_PrintUserMessage(Main.CurrentInterface, Main.ActiveTransactionHandle, ref stUserMessage, 1, ref m_stTicket, Defines.TIMEOUT_DEFAULT);
