...
{
    public partial class PLUDialog : XtraForm
    {
        public PLUDialog()
        {
            InitializeComponent();
        ...
        void RefreshEcrPluDbFileName()
        {
            ...
            Retcode = GMPSmartDLL.FP3_GetPluDatabaseInfo(Main.CurrentInterface, arrDbName, ref PluDbType, ref m_PluDbSize, ref PluDbGrupsLastModified, ref PluDbItemsLastModified);
        ...
        private void m_btnUploadtoPC_Click(object sender, EventArgs e)
        {
            ...
            using (BinaryWriter b = new BinaryWriter(File.Open(HostFileName, FileMode.OpenOrCreate)))
            {
                ...
                while ((Retcode = GMPSmartDLL.FP3_FileSystem_FileRead(Main.CurrentInterface, m_PluDbName, Offset, Whence, Buffer, Buffer.Length, ref ReadLen)) == Defines.TRAN_RESULT_OK)
                {
        ...
        private void m_btnDownloadtoECR_Click(object sender, EventArgs e)
        {
            ...
            if (csFileNamePlu != m_PluDbName)  //if( csFileNamePlu == m_PluDbName)  
            {
                ...
                Retcode = GMPSmartDLL.FP3_SetPluDatabaseInfo(Main.CurrentInterface, csFileNamePlu, 0);
                if (Retcode != Defines.TRAN_RESULT_OK)
                    goto Exit;
            }
            else
            ...
            using (BinaryReader b = new BinaryReader(File.Open(hostFileName, FileMode.Open)))
            {
                ...
                Retcode = GMPSmartDLL.FP3_FileSystem_FileRemove(Main.CurrentInterface, Encoding.Default.GetBytes(csFileNamePlu));
                ...
                while (true)
                {
                    ...
                    do
                    {
                        Retcode = GMPSmartDLL.FP3_FileSystem_FileWrite(Main.CurrentInterface, Encoding.Default.GetBytes(csFileNamePlu), offset, 0, buffer, ReadLen);
        ...
        void commonECR_DBFunc(int commandType)
        {
            ...
            UInt32 Retcode = GMPSmartDLL.FP3_Database_Open(Main.CurrentInterface, m_PluDbName);
            if ((Retcode != Defines.SQLITE_OK))
                goto Exit;
            ...
            Retcode = Json_GMPSmartDLL.FP3_Database_Execute(Main.CurrentInterface, sqlWord, ref stDatabaseResult);
            ...
            try
            {
                ...
                if (Retcode == Defines.TRAN_RESULT_OK)
                {
                    ...
                    if (StDatabaseResult.pstCaptionArray != null)
                    {
                        ...
                        {
                            Retcode = GMPSmartDLL.FP3_Database_QueryFinish(Main.CurrentInterface);
                            goto Exit;
                        }
