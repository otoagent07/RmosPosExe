...
namespace RmosIngenicoGMP
{
    public partial class Main : XtraForm
    {
        ...
        public static string GMP_SIM_VERSION = "v15r29";
        ...
        void StartBackgroundTransaction_Click(object sender, EventArgs e)
        {
            ...
            Retcode = GMPSmartDLL.FP3_Start(CurrentInterface, ref TransactionHandle, IsBackground, GetUniqueIdByInterface(CurrentInterface), 24, TsmSign, TsmSign == null ? 0 : TsmSign.Length, null, 0, 10000);
        ...
        void SwitchBackgroundToForeground_Click(object sender, EventArgs e)
        {
            ...
            Retcode = GMPSmartDLL.FP3_FunctionLoadBackGroundHandleToFront(CurrentInterface, TransactionHandle, Defines.TIMEOUT_DEFAULT);
        ...
        string mesajYorumla(string msj)
        {
            ...
            string[] Islem = msj.Split(';');

            if (msj.Length > 1)
            {
                satislar = JsonConvert.DeserializeObject<List<Satislar>>(Islem[1].ToString());
                SatisYap(Islem);
            }
        ...
        private void SatisYap(string[] Islem)
        {
            ...
            if (Islem[0].Trim() == "SATIS")
            {
                m_btn_Click(m_btnK_017, null);
                Indirim(satislar);
                NakitOdeme(satislar);
                OdemeDiger(satislar);
                m_btn_Click(m_btn_043, null);
                YemekCekiOdeme(satislar);
            }
            if (Islem[0].Trim() == "ODEME")
            {
                NakitOdeme(satislar);
                OdemeDiger(satislar);
                m_btn_Click(m_btn_043, null);
            ...
            if (Islem[0].Trim() == "FISIPTAL")
            {
                m_btn_Click(m_btnVoidAllTicket_059, null);
            }
            if (Islem[0].Trim() == "FISKAPAT")
            {
                m_btn_Click(m_btn_031, null);
            }
            if (Islem[0].Trim() == "YENIDENYUKLE")
            {
                m_btnReloadTransaction_Click(null, null);
            }
            if (Islem[0].Trim() == "KAGITBITINCE")
            {
                m_btn_Click(m_btnVoidAllTicket_059, null);
                m_btn_Click(m_btnK_017, null);
                Indirim(satislar);
            ...
            if (Islem[0].Trim() == "GETTICKET")
            {
                GetReceiptOptionFlags(CurrentInterface);
            }

        }

        private void YemekCekiOdeme(List<Satislar> satislar)
        {
            foreach (var item in satislar)
            {
                if (item.BA == "A" && item.odemeKodu == 4)
                {
                    ...
                    Retcode = Json_GMPSmartDLL.FP3_GetVasApplicationInfo(CurrentInterface, ref NumberOfTotalRecord, ref NumberOfTotalRecordReceived, ref StPaymentApplicationInfo, (ushort)EVasType.TLV_OKC_ASSIST_VAS_TYPE_YEMEKCEKI);
                    ...
                    else
                    {
                        ...
                        */
                        ...
                        amount = (uint)getAmount(tutarToIngc(objToDecimal(item.Tutar, 0, true)).ToString());
        ...
        void server_DataReceived(object sender, SimpleTCP.Message e)
        {
            this.Invoke((MethodInvoker)delegate ()
            {
                ...
                if (paketDogru(e.MessageString))
                {
                    ...
                    veri = e.MessageString;
                    e.ReplyLine(mesajYorumla(veri));
        ...
        {
            if (Properties.Settings.Default.DefaultCulture == "en-GB")
            {
                Properties.Settings.Default.DefaultCulture = "tr-TR";
                ...
                {
                    Application.Exit();
                    Process.Start("RmosIngenicoGMP.exe");
                }
            }
            else
            {
        ...
        {
            if (Properties.Settings.Default.DefaultCulture == "tr-TR")
            {
                Properties.Settings.Default.DefaultCulture = "en-GB";
                Properties.Settings.Default.Save();
        ...
        public decimal objToDecimal(Object Bilgi, decimal varsayilan = 0, bool temizle = false)
        {
        ...
        public string objToStr(object Bilgi, string varsayilan = "")
        {
        ...
        public object tutarTemizle(object tutar)
        {
            object sonuc = null;
            if (tutar == null) return sonuc;

            string veri = objToStr(tutar).Trim();
        ...
        private void RMOS_DepartmentSale(int deptIndex, List<Satislar> satislar)
        {
            ...
            foreach (var item in satislar)
            {
                if (item.BA == "B")
                {
                    ...
                    itemCount = Convert.ToUInt32(item.Miktar);
                    ...
                    for (int i = 0; i < indexOfTaxRates; i++)
                    {
                        ...
                        if (Convert.ToInt32((stTaxRates[stDepartments[i].u8TaxIndex].taxRate / 100)) == Convert.ToInt32(item.kdvOran))
                        {
                            item.Ykasaid = i;
                            break;
                        }
                    ...
                    m_txtInputData.Text = (tutarToIngc(objToDecimal(item.Tutar, 0, true))).ToString();

                    stItem.subType = 0;
                    stItem.deptIndex = (byte)item.Ykasaid;
                    ...
                    Start:
                        ...
                        if (Retcode == Defines.APP_ERR_FIS_LIMITI_ASILAMAZ)
                        {
                            ...
                            //m_btn_Click(m_btnVoidAllTicket_059, null);
                            return;
                            //DialogResult dr = RmosIngenicoGMP.Properties.Settings.Default.DefaultCulture == "en-GB" ?
        ...
        private void FaturaKes(ST_TICKET m_stTicket)
        {
                ...
                case 17:
                    {
                        foreach (var item in satislar)
                        {
                            if (item.BA == "B")
                            {
                                ...
                                m_txtInputData.Text = item.Tutar.ToString();
                                DepartmentSale(item.Ykasaid, (decimal)item.Miktar, m_txtInputData.Text, "", item.Adi);//K1
                                m_txtInputData.Text = "";
                            }
                        }
                        break;
                    }
                case 18: DepartmentSale(2, 0, "", "", ""); break;  //K2
                case 19: DepartmentSale(3, 0, "", "", ""); break;  //K3
                case 20: DepartmentSale(4, 0, "", "", ""); break;  //K4
                case 21: DepartmentSale(5, 0, "", "", ""); break;  //K5
                case 22: DepartmentSale(6, 0, "", "", ""); break;  //K6
                case 23: DepartmentSale(7, 0, "", "", ""); break;  //K7
                case 24: DepartmentSale(8, 0, "", "", ""); break;  //K8
                case 25: DepartmentSale(9, 0, "", "", ""); break;  //K9
                case 26: DepartmentSale(10, 0, "", "", ""); break; //K10
                case 27: DepartmentSale(11, 0, "", "", ""); break; //K11
                case 28: DepartmentSale(12, 0, "", "", ""); break; //K12
                        ...
                        foreach (var item in satislar)
                        {
                            if (item.BA == "A" && item.odemeKodu == 3)
                            {
                                ...
                                else
                                {
                                    ...
                                    m_txtInputData.Text = ((tutarToIngc(objToDecimal(item.Tutar.ToString(), 0, true))).ToString());
                                    if (m_txtInputData.Text.Length != 0)
                                    {
                                        amount = (uint)getAmount(m_txtInputData.Text);
                                        m_txtInputData.Text = "";
        ...
        private void DepartmentSale(int deptIndex, decimal Miktar, string Tutar, string Barcode, string Adi)
        {
            ...
            stItem.subType = 0;
            stItem.deptIndex = (byte)(deptIndex);
            stItem.amount = (uint)getAmount((tutarToIngc(objToDecimal(Tutar, 0, true))).ToString());
            stItem.currency = currency;
            stItem.count = (uint)Miktar;
            stItem.unitType = unitType;
            stItem.pluPriceIndex = 0;
            stItem.countPrecition = 0;
            stItem.name = Adi;
        ...
        void Indirim(List<Satislar> satislar)
        {
            UInt16 m_itemNo = 0xFFFF;
            m_type = 1;
            foreach (var item in satislar)
            {
                if (item.BA == "A" && item.odemeKodu == 21)
                {
                    string str1 = "İNDİRİM";
                    ...
                    else
                    {
                        ...
                        if (m_type == 0)    //amount Increase{
                        {
                            Retcode = Json_GMPSmartDLL.FP3_Plus(CurrentInterface, GetTransactionHandle(CurrentInterface), changedAmount, str1, ref m_stTicket, m_itemNo, Defines.TIMEOUT_DEFAULT);
                            str1 = Localization.AmountIncrease;
                        }
                        else if (m_type == 1)//amount Decrease
                        {
                            Retcode = Json_GMPSmartDLL.FP3_Minus(CurrentInterface, GetTransactionHandle(CurrentInterface), changedAmount, str1, ref m_stTicket, m_itemNo, Defines.TIMEOUT_DEFAULT);
                        }
                        else if (m_type == 2)//percent Increase
                        {
        ...
        private void m_readCardMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Retcode = Json_GMPSmartDLL.FP3_FunctionReadCard(CurrentInterface, (READER_TYPE_MCR | READER_TYPE_SCR | READER_TYPE_CLESS), ref stCardInfo, (60 * 1000));
        ...
        private void LastLoaded(UInt32 Retcode)
        {
            int flag = 0;
            if (Retcode == Defines.APP_ERR_ALREADY_DONE)
            {
        ...
        private void m_btnServiceComplete_Click(object sender, EventArgs e)
        {
            ...
            //RmosIngenicoGMP.ServiceReference1.TSM_GetUniqueIdIn input = new RmosIngenicoGMP.ServiceReference1.TSM_GetUniqueIdIn();
            //RmosIngenicoGMP.ServiceReference1.TSM_GetUniqueIdOut output = new RmosIngenicoGMP.ServiceReference1.TSM_GetUniqueIdOut();
        ...
        private void m_jumpToECRSinglePaymentMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Retcode = Json_GMPSmartDLL.FP3_JumpToECR(CurrentInterface, GetTransactionHandle(CurrentInterface), Defines.GMP3_OPTION_RETURN_AFTER_SINGLE_PAYMENT, ref m_stTicket, Defines.TIMEOUT_CARD_TRANSACTIONS);
        ...
        private void m_btnCompleteJumpToEcr_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Retcode = Json_GMPSmartDLL.FP3_JumpToECR(CurrentInterface, GetTransactionHandle(CurrentInterface), Convert.ToUInt64(m_lblOptionSum.Text), ref m_stTicket, Defines.TIMEOUT_DEFAULT);
        ...
        {
            Retcode = GMPSmartDLL.FP3_IsGmpPairingDone(CurrentInterface);
            if (Retcode == 0)
        ...
        public int DepartmentSaleForTaxTest(int deptIndex)
        {
            ...
            Retcode = Json_GMPSmartDLL.FP3_GetTaxRates(Main.CurrentInterface, ref numberOfTotalTaxRates, ref numberOfTotalRecordsReceived, ref stTaxRatesTmp, 8);
            Retcode = Json_GMPSmartDLL.FP3_GetDepartments(Main.CurrentInterface, ref numberOfTotalDepartments, ref numberOfTotalRecordsReceived, ref stDepartmentsTmp, 12);
            ...
            if (isTaxHasChanged)
            {
                ...
                Retcode = Json_GMPSmartDLL.FP3_GetDepartments(Main.CurrentInterface, ref numberOfTotalDepartments, ref numberOfTotalRecordsReceived, ref stDepartments, 12);
                ...
                if (isTaxHasChanged)
                {
                    ...
                    if (pf.m_PASS != "")
                    {
                        Retcode = Json_GMPSmartDLL.FP3_SetDepartments(Main.CurrentInterface, ref stDepartments, 12, pf.m_PASS);
                    }
                }
            }
        ...
        private void NakitOdeme(List<Satislar> satislar)
        {
            foreach (var item in satislar)
            {
                if (item.BA == "A" && item.odemeKodu == 1)
                {
                    m_txtInputData.Text = (tutarToIngc(objToDecimal(item.Tutar, 0, true))).ToString();
                    UInt32 amount = 0;
        ...
        private void setExchangeProfileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            result = Json_GMPSmartDLL.FP3_GetCurrencyProfile(Main.CurrentInterface, ref profiles);
            if (result != 0)
            {
        ...
        private void vASÖdemeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Retcode = Json_GMPSmartDLL.FP3_GetVasApplicationInfo(CurrentInterface, ref pNumberOfTotalRecords, ref pNumberOfTotalRecordsReceived, ref stPaymentAppInfo, vasType);
            ...
            else
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    Json_GMPSmartDLL.FP3_GetVasPaymentServiceInfo(CurrentInterface, ref pNumberOfTotalRecords, ref pNumberOfTotalRecords, ref stVasPaymentServiceInfo, vasAppID);
                    ...
                    stPaymentRequest[0].typeOfPayment = (uint)stVasPaymentServiceInfo[0].List[0].PaymentType;
                    stPaymentRequest[0].subtypeOfPayment = 0;
                    stPaymentRequest[0].payAmount = amount;
                    stPaymentRequest[0].payAmountCurrencyCode = currencyOfPayment;
        ...
        private void buttonEBiletGönder_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Girdiğiniz değerleri kontrol ediniz lütfen!", "HATA", MessageBoxButtons.OK);
                return;
            }
        ...
        private void userMessageToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            GMPSmartDLL.FP3_GetDialogInput_MsgBox(CurrentInterface, ref Retcode, 0x0FFFFF, title, text, 1, 3, 30000);
        }
        ...
        private void OdemeDiger(List<Satislar> satislar)
        {
            foreach (var item in satislar)
            {
                if (item.BA == "A" && (item.odemeKodu > 4 && item.odemeKodu < 15))
                {
                    uint amount = (uint)getAmount(tutarToIngc(objToDecimal(item.Tutar, 0, true)).ToString());
                    UInt16 currencyOfPayment = 949;
                    ...
                    if (string.IsNullOrEmpty(item.OdemeAdi)) item.OdemeAdi = "DigerOdemeler";

                    stPaymentRequest[0].typeOfPayment = (uint)BulPaymentType(item.odemeKodu);//m_PaymentType;
                    stPaymentRequest[0].subtypeOfPayment = 0;
                    stPaymentRequest[0].payAmount = amount;
                    stPaymentRequest[0].payAmountCurrencyCode = currencyOfPayment;
                    stPaymentRequest[0].paymentName = "* " + item.OdemeAdi; //"INGENICO";
        ...
        private void Main_Load(object sender, EventArgs e)
        {
            ...
            //"İNDİRİM" = ini.Read("Ayarlar", "Indnot");
            ...
            Localization.Culture = new CultureInfo(Properties.Settings.Default.DefaultCulture);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int say = 0;
            foreach (var item in cmb_Dep.Properties.Items)
            {
                PKod pk1 = new PKod();
