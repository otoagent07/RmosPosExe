...
{
    public partial class CurrencyProfileForm : XtraForm
    {
        public uint Retcode;
        ...
        public void SetCurrencyProfiles()
        {
            ...
            Retcode = Json_GMPSmartDLL.FP3_GetCurrencyProfile(Main.CurrentInterface, ref stExchangeProfilesTemp);
            if (Retcode != 0)
            {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            {
                // process type = 2 -> add
                Retcode = Json_GMPSmartDLL.FP3_SetCurrencyProfile(Main.CurrentInterface, password, (byte)newItem, 2, ExchangeProfiles);  
            }
            else
            {
                // process type = 1 -> update
                Retcode = Json_GMPSmartDLL.FP3_SetCurrencyProfile(Main.CurrentInterface, password, index, 1, ExchangeProfiles);
            }
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            string password = "0000";
            Retcode = Json_GMPSmartDLL.FP3_SetCurrencyProfile(Main.CurrentInterface, password, (byte)index, 3, stExchangeProfiles);
