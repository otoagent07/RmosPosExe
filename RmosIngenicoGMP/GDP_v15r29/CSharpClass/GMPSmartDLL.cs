...
namespace RmosIngenicoGMP
{
    ...
    class ST_VAS_PAYMENT_SERVICE_INFO
    {
        ...
        byte nbPaymentCount;                        /**< Number of supported payment type*/
        public class Payment
        {
            public string PaymentName;//[MAX_VAS_PAYMENT_NAME];  /**< Payment Name*/
            public ulong PaymentType;                      /**< Payment Type*/
        }
        public Payment [] List;
    ...
    class Defines
    {
        ...
        public const int TIMEOUT_DEFAULT = 60000;	// 10 seconds
        public const int TIMEOUT_CARD_TRANSACTIONS = 100000;	// 100 seconds
        public const int TIMEOUT_ECHO = 20000;	// 10 seconds
